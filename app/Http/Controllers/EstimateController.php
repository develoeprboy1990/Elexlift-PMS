...
class EstimateController extends Controller
{
  ...
  public function EstimateCreate()
  {
        ...
        return view('estimate.estimate_create', compact( 'party', 'pagetitle', 'estimate_master', 'items', 'item', 'user','tax'));
  ...
  public function EstimateEdit($id)
  {
    ...
    return view('estimate.estimate_edit', compact( 'party', 'pagetitle', 'estimate_master', 'items', 'item',  'user',  'estimate_detail','tax'));
  }
