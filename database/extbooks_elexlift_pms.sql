...
(1, 'Extensive IT Services', '(PVT) LTD', '123456789', 'AED', NULL, '+971 4 584 8310', 'info@eits.ae', 'www.eits.ae', 'Office #1807 Clover Bay Tower, Business Bay - Dubai', '1680632089.png', '1680632089.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-07-28 09:46:01', '2023-07-28 09:46:01');
...
(5, 'EST-00001', 'Ahsan Elahi', 'MR', '2', '48V AC', 'Brake Voltage', 'Moter', 'ECN 1313', '2', 'with', '2023-07-31', 'Fermator', '1690626536.jpg', '[\"Intercom\",\"Load sensor\"]', 'EstimateNo', 'active', 'Pending', 1, '2023-07-29 05:28:56', '2023-07-29 05:28:56');
...
(7, 2, 5, 'New Job Assigned to You', 0, '2023-07-29 05:28:56', '2023-07-29 05:28:56');
...
CREATE TABLE `user_job_reply` (
  ...
  `UserID` int DEFAULT NULL,
  `UserReply` text,
  `UserJobStatus` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
ALTER TABLE `user_job_reply`
  MODIFY `ReplyID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
